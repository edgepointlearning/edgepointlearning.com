...
(function(){
  ...
  *********************************************************************/
  var vimeo = document.querySelectorAll('.vi-lazyload'),
      ...
      settings_thumb_base_url         = 'https://eleventy--edgepointlearning.netlify.app/static/vi-lazyload/',      //TODO: CHANGE THIS WHEN LAUNCHED. Base URL where thumbnails are stored
